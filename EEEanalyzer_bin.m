...
function EEEanalyzer_bin(figSaveMode, fName, fDir, v20Name, v20Dir, doDqm, doStats)
    ...
    *=calcualted field
    ...
    csvwrite(strcat(fDir, '/dirty data.xls'), dati);
    ...
    csvwrite(strcat(fDir, '/chi2.xls'), chiArray);  %save excel file for chi2 rejects
    ...
    csvwrite(strcat(fDir, '/tof.xls'), tofArray);  %save excel file for tof rejects
    ...
    csvwrite(strcat(fDir, '/clean data.xls'), dati);  %save excel file for tof rejects
